...
export default function NewMeal() {
  ...
  const onSubmitForm = (event) => {
    ...
    axios
      .post(`/api/meals/?userId=${userId}&accountId=${accountId}`, body)
      .then((response) => {
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="form-group">
                <label for="day" class="col-lg-2 control-label">
                  Day
                </label>
                <div>
                  <input
              ...
              <div class="form-group">
                <label for="snack" class="control-label">
                  Snack
                </label>
                <div>
                  <input
              ...
              <div class="form-group">
                <label for="dinner" class=" control-label">
                  Dinner
                </label>
